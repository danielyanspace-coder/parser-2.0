...
curl -u admin:ВАШ_ADMIN_PASSWORD -X PUT --data-binary @releases/alfa-sms-v2.9.apk \
  https://project.alfa-vpn.ru/admin/apk
curl -u admin:ВАШ_ADMIN_PASSWORD -X POST -H "Content-Type: application/json" \
  -d '{"versionCode":10,"versionName":"2.9","notes":"Новая система мониторинга сигналов с большей конверсией"}' \
